...
- Add MQTT Support for results. Original [#422](https://github.com/greenbone/ospd-openvas/pull/422). Reintroduce after rebase [#449](https://github.com/greenbone/ospd-openvas/pull/449).
